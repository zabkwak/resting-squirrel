...
var Err, __checkAuth, __checkParams, __endpoints, __handle, __hasObjectValue, __mergeObjects, __methods, __options, bodyParser, compression, express, p;
    ...
    res.sendData = function(data, key) {
      ...
      if (o.meta) {
        r._meta = {
          ...
          "rs": {
            version: p.version,
            module: "https://www.npmjs.com/package/" + p.name
          },
          request: {
            endpoint: req.method + " " + req.path,
            body: body,
