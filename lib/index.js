...
var Err, __checkAuth, __checkParams, __endpoints, __handle, __hasObjectValue, __mergeObjects, __methods, __options, bodyParser, compression, express;
...
module.exports = function(options) {
  ...
  app.use(function(req, res, next) {
    ...
    res.sendData = function(data, key) {
      ...
      if (o.log) {
        error = "";
        console.log(new Date, res.statusCode + " " + req.method + " " + req.path + " BODY: " + (JSON.stringify(body)) + " HEADERS: " + (JSON.stringify(req.headers)) + " TOOK: " + took + " ms");
        console.log("");
      }
      return res.json(r);
    };
