...
var __checkAuth, __checkParams, __handle, __hasObjectValue, __methods, __options, bodyParser, compression, express;
...
__handle = function(app, options, method, route, requiredAuth, requiredParams, callback) {
...
module.exports = function(options) {
  ...
  for (k in __options) {
    v = __options[k];
    o[k] = options[k] !== void 0 ? options[k] : v;
  }
  app = express();
  app.use(compression());
  ...
  cb = function(method) {
    return function(route, requiredAuth, requiredParams, callback) {
      return __handle(app, o, method, route, requiredAuth, requiredParams, callback);
    };
  };
