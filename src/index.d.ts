 ...
 */
declare interface IRequest<A = any, Q = any, B = any, EP = Record<string, any>> extends express.Request {
...
declare type Type = RuntimeType.Type;

declare type RouteCallback<R extends IRequest<any, any, any, any>> = (req: R, res: IResponse, next: (error?: HttpSmartError | SmartError | Error | string | null, data?: any) => void) => void | Promise<any>;

declare type MiddlewareNext = (error?: HttpSmartError | SmartError | Error | string | null) => void;
...
declare enum RouteAuth {
	REQUIRED = 2,
	DISABLED = 0,
	OPTIONAL = 1,
}

declare interface RouteOptions<IProps = Record<string, any>> {
	/** 
...
declare class Application {
	 ...
	 * @param callback Callback to execute.
	 */
	get<R extends IRequest<any, any, any, EP>, EP = Record<string, any>>(route: string, options: RouteOptions<EP>, callback: RouteCallback<R>): Endpoint<R, EP>;
	/**
	 ...
	 * @param callback Callback to execute.
	 */
	get<R extends IRequest<any, any, any, EP>, EP = Record<string, any>>(version: number, route: string, options: RouteOptions<EP>, callback: RouteCallback<R>): Endpoint<R, EP>;
	 ...
	 * @param callback Callback to execute.
	 */
	put<R extends IRequest<any, any, any, EP>, EP = Record<string, any>>(route: string, options: RouteOptions<EP>, callback: RouteCallback<R>): Endpoint<R, EP>;
	/**
	 ...
	 * @param callback Callback to execute.
	 */
	put<R extends IRequest<any, any, any, EP>, EP = Record<string, any>>(version: number, route: string, options: RouteOptions<EP>, callback: RouteCallback<R>): Endpoint<R, EP>;
	 ...
	 * @param callback Callback to execute.
	 */
	post<R extends IRequest<any, any, any, EP>, EP = Record<string, any>>(route: string, options: RouteOptions<EP>, callback: RouteCallback<R>): Endpoint<R, EP>;
	/**
	 ...
	 * @param callback Callback to execute.
	 */
	post<R extends IRequest<any, any, any, EP>, EP = Record<string, any>>(version: number, route: string, options: RouteOptions<EP>, callback: RouteCallback<R>): Endpoint<R, EP>;
	 ...
	 * @param callback Callback to execute.
	 */
	delete<R extends IRequest<any, any, any, EP>, EP = Record<string, any>>(route: string, options: RouteOptions<EP>, callback: RouteCallback<R>): Endpoint<R, EP>;
	/**
	 ...
	 * @param callback Callback to execute.
	 */
	delete<R extends IRequest<any, any, any, EP>, EP = Record<string, any>>(version: number, route: string, options: RouteOptions, callback: RouteCallback<R>): Endpoint<R, EP>;
	 ...
	 * @param callback Callback to execute.
	 */
	registerRoute<R extends IRequest<any, any, any, EP>, EP = Record<string, any>>(method: string, route: string, options: RouteOptions<EP>, callback: RouteCallback<R>): Endpoint<R, EP>;
	/**
	 ...
	 * @param callback Callback to execute.
	 */
	registerRoute<R extends IRequest<any, any, any, EP>, EP = Record<string, any>>(method: string, version: number, route: string, options: RouteOptions<EP>, callback: RouteCallback<R>): Endpoint<R, EP>;
...
declare class Endpoint<R extends IRequest<any, any, any, any> = any, IProps = Record<string, any>> {
...
declare class Param /* extends Field */ {
